...
const companies = [
   {
    ...
    deafEmployees: 60,
    hasInterpreter: null,
    benefits: ['Apoio de inclusão', 'Comunicação acessível', 'Atuação em produção e logística'],
  },
  {
    name: 'Carrefour',
    industry: 'Varejo / Supermercados',
    employees: '130.000+',
    rating: 3.7,
    location: 'Alphaville - SP',
    deafEmployees: 100,
    hasInterpreter: true,
    benefits: ['Treinamento em Libras para líderes', 'Atuação em lojas e centros de distribuição'],
  },
  {
    name: 'Magazine Luiza',
    industry: 'Varejo / Tecnologia',
    employees: '37.000+',
    rating: 4.2,
    location: 'Franca - SP',
    deafEmployees: 30,
    hasInterpreter: null,
    benefits: ['Atuação em logística', 'Atendimento', 'Áreas administrativas'],
  },
  {
    name: "McDonald's (Arcos Dorados)",
    industry: 'Alimentação / Fast food',
    employees: '60.000+',
    rating: 3.6,
    location: 'São Paulo - SP',
    deafEmployees: 40,
    hasInterpreter: null,
    benefits: ['Equipes com múltiplos colaboradores surdos', 'Ambiente inclusivo'],
  },
];
