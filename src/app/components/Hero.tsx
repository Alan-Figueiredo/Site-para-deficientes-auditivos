  ...
  return (
    <section id="inicio" className="bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 py-16 md:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Libras Notice */}
        <div className="bg-blue-600 text-white px-6 py-4 rounded-lg mb-8 flex items-center justify-between flex-wrap gap-4">
          <div className="flex items-center gap-3">
            <div className="bg-white/20 p-2 rounded-lg">
              <TrendingUp className="w-6 h-6" />
            </div>
            <div>
              <p className="font-semibold">🎥 Todo conteúdo disponível em Libras!</p>
              <p className="text-sm text-blue-100">Assista à tradução completa de cada seção</p>
            </div>
          </div>
          <LibrasButton section="hero" variant="secondary" />
        </div>
